...
import { SearchPanel, isSearchFocusShortcut, shouldIgnoreSearchCardKeyboardActivation } from "@/features/search/components/SearchPanel";
...
describe("SearchPanel", () => {
  ...
  it("renders full session ids and full normalized sources for search result cards", () => {
    ...
    expect(html).not.toContain("019d2f65…4d85");
  });
